...
class barang_pembantu extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        checkAccess($this->session->userdata('fiturview')[19]);
    }
    ...
    public function index()
    {
        ...
        if (!$this->input->is_ajax_request()) {
            ...
            $data['menu'] = 'pembantu';
            $data['title'] = 'List Barang Pembantu';
            $data['view'] = 'transaksi/v_barang_pembantu';
            $data['scripts'] = 'transaksi/s_barang_pembantu';
            ...
            $configData['where'] = ["j.NamaJenisBarang LIKE '%BARANG PEMBANTU%'"];
            ...
            $FiturID = 19; //FiturID di tabel serverfitur
            $canEdit = 0;
            $edit = [];
