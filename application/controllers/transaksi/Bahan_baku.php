...
class bahan_baku extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        checkAccess($this->session->userdata('fiturview')[17]);
    }
    ...
    public function index()
    {
        ...
        if (!$this->input->is_ajax_request()) {
            ...
            $data['view'] = 'transaksi/v_bahan_baku';
            $data['scripts'] = 'transaksi/s_bahan_baku';
            ...
            $configData['where'] = ["j.NamaJenisBarang LIKE '%BAHAN BAKU%'"];
            ...
            $FiturID = 17; //FiturID di tabel serverfitur
            $canEdit = 0;
            $edit = [];
