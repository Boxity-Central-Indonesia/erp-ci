			...
			<div class="breadcrumb-main">
				...
				<div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <div class="dropdown action-btn">
                    	<a target="_blank" href="<?= base_url('laporan/persediaan_barang/cetak') ?>" id="btn-cetak" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button">
				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-persediaanbrg" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2">
