...
<div class="container text-center">
    <span class="text-center" style="font-size:15pt; font-weight:bold;">Laporan Penjualan</span><br>
...
<table width="100%"  border="1" style="font-size: 10pt; padding: 2px">
    <tr>
        ...
        <td class="text-center" style="line-height: 20px; width:15%"><b>Nama Customer</b></td>
        <td class="text-center" style="line-height: 20px; width:10%"><b>Total Tagihan</b></td>
        <td class="text-center" style="line-height: 20px; width:10%"><b>Total Dibayar</b></td>
        <td class="text-center" style="line-height: 20px; width:15%"><b>Status Bayar</b></td>
    </tr>';
    ...
    foreach ($model as $row) {
        ...
        $html .= '<td class="text-left">' . $row['StatusBayar'] . '</td>';
        $html .= '</tr>';
...
$pdf->Output('Laporan_Penjualan_' . shortdate_indo(date('Y-m-d', strtotime($tglawal))) . '_' . shortdate_indo(date('Y-m-d', strtotime($tglakhir))) . '.pdf', 'I');
?>