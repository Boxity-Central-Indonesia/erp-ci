...
<div class="container text-center">
    <span class="text-center" style="font-size:15pt; font-weight:bold;">Laporan Pembelian</span><br>
...
<table width="100%"  border="1" style="font-size: 10pt; padding: 2px">
    <tr>
        ...
        <td class="text-center" style="line-height: 20px; width:15%"><b>Nama Supplier</b></td>
...
$pdf->Output('Laporan_Pembelian_' . shortdate_indo(date('Y-m-d', strtotime($tglawal))) . '_' . shortdate_indo(date('Y-m-d', strtotime($tglakhir))) . '.pdf', 'I');
?>