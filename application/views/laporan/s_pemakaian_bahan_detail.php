<script>
    const $table = $('#table-pemakaiandetail').DataTable({
        "paging": false,
        "lengthChange": false,
        "searching": false,
        "ordering": true,
        ...
        "ajax": {
            "url": "<?= base_url('laporan/pemakaian_bahan/detail'); ?>",
            "type": "GET",
            "data": function(d) {
    ...
    $('#tgl-transaksi').daterangepicker({
        ...
        function(start, end) {
            ...
            var url = '<?= base_url('laporan/pemakaian_bahan/cetak/') ?>' + btoa('<?= $KodeBarang ?>') + '/' + btoa($("#tgl-transaksi").val());
