<style type="text/css">
    #ModalTambahTP { overflow-y:scroll !important; }
</style>
			...
			<div class="breadcrumb-main">
				...
				<div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <div class="dropdown action-btn">
                    	<a target="_blank" href="<?= base_url('laporan/piutang/cetak/') . base64_encode(date('Y-m-d', strtotime($tglawal)) . ' - ' . date('Y-m-d', strtotime($tglakhir))) ?>" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button" id="btn-cetak">
				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-piutang" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="3">
