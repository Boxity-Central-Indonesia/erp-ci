                        ...
                        <div class="table-responsive">
                            ...
                            <div class="col-sm-12">
                                <div class="action-btn row clearfix">
                                    <div>Daftar Terima Piutang</div>
                                </div>
                            </div>
                            <table id="table-piutangdetail" class="table mb-0 table-borderless">
                                <thead>
                                    <tr class="userDatatable-header">
                                        <th style="display: table-cell; width:4%"><span class="userDatatable-title">No</span></th>
                                        <th style="display: table-cell;"><span class="userDatatable-title">Kode Terima </span></th>
                                        <th style="display: table-cell;"><span class="userDatatable-title">Tanggal Terima </span></th>
                                        <th style="display: table-cell;"><span class="userDatatable-title">Jenis Bayar </span></th>
                                        <th style="display: table-cell;"><span class="userDatatable-title">Diterima Oleh </span></th>
