...
<div class="container text-center">
    <span class="text-center" style="font-size:15pt; font-weight:bold;">Laporan Persediaan Barang</span><br>
    <span class="text-center" style="font-size:11pt; font-weight:none !important;">' . strftime('%d %B %Y', strtotime($date)) . '</span>
</div>
<br>
<div style="font-size:14pt;">' . $namagudang . '</div>
<table width="100%"  border="1" style="font-size: 12pt; padding: 4px">
    <tr>
        ...
        <td class="text-center" style="line-height: 20px; width:15%"><b>Stok</b></td>
    </tr>';
...
$pdf->Output('Laporan_Persediaan_Barang_' . $judul . '_' . $date . '.pdf', 'I');
?>