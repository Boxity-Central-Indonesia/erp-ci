			...
			<div class="breadcrumb-main">
				...
				<div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <div class="dropdown action-btn">
                    	<a target="_blank" href="<?= base_url('laporan/hp_penjualan/cetak') ?>" id="btn-cetak" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button">
				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-hppenjualan" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2">
					                ...
					                <tr class="userDatatable-header">
					                    ...
					                    <th style="display: table-cell;"><span class="userDatatable-title">Item Penjualan </span></th>
					                    ...
					                    <th style="display: table-cell;" class="text-center"><span class="userDatatable-title">Total HPP </span></th>
