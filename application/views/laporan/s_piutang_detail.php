<script>
    var tagawal = 0;
    const $table = $('#table-piutangdetail').DataTable({
        "paging": false,
        "lengthChange": false,
        "searching": false,
        "ordering": true,
        ...
        "ajax": {
            "url": "<?= base_url('laporan/piutang/detail'); ?>",
            "type": "GET",
            "data": function(d) {
    ...
    $(document).ready(function() {
        $("#table-piutangdetail").on("click", ".btnhapus", function() {
    ...
    function hapus(kode, kode2) {
        ...
        get_response("<?= base_url('laporan/piutang/hapusdetail') ?>", data, function(response) {
