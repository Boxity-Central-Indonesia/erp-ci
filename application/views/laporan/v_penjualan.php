			...
			<div class="breadcrumb-main">
				...
				<div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <div class="dropdown action-btn">
                    	<a target="_blank" href="<?= base_url('laporan/penjualan/cetak/' . base64_encode(date('Y-m-d', strtotime($tglawal)) . ' - ' . date('Y-m-d', strtotime($tglakhir)))) ?>" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button" id="btn-cetak">
				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-lappenjualan" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2">
										...
										<td colspan="2">
											<div class="form-group">
												<label class="form-control-label">Total Tagihan</label>
												<input type="text" name="" class="form-control" id="total-tagihan" style="padding: 5px; box-sizing: border-box; text-align: right;" readonly>
											</div>
										</td>
										<td colspan="2">
											<div class="form-group">
												<label class="form-control-label">Total Dibayar</label>
												<input type="text" name="" class="form-control" id="total-dibayar" style="padding: 5px; box-sizing: border-box; text-align: right;" readonly>
											</div>
										</td>
					                </tr>
