<script>
    ...
    $('#tgl-transaksi').daterangepicker({
        ...
        function(start, end) {
            ...
            var url = '<?= base_url('laporan/hutang/cetak/') ?>' + btoa($("#tgl-transaksi").val());
    ...
    function filtrasi() {
        ...
        get_response("<?= base_url('laporan/hutang/get_total') ?>", data, function(res) {
