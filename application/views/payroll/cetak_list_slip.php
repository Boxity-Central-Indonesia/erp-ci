...
$pdf->SetTitle('Daftar Laporan Slip Gaji');
...
<head>
  ...
  <title>Daftar Laporan Slip Gaji</title>
...
<div class="container text-center">
    <span class="text-center" style="font-size:15pt; font-weight:bold;">Daftar Laporan Slip Gaji</span><br>
...
<table width="100%"  border="1" style="font-size: 11pt; padding: 2px">
    <tr>
        ...
        <td class="text-center" style="line-height: 20px; width:15%"><b>Jabatan</b></td>
        <td class="text-center" style="line-height: 20px; width:20%"><b>Total Perolehan</b></td>
        <td class="text-center" style="line-height: 20px; width:20%"><b>Status Dibayarkan</b></td>
    </tr>';
    ...
    foreach ($model as $row) {
        ...
        $status = $row['IsTelahDibayarkan'] == 0 ? 'Belum' : 'Sudah';
        $html .= '<tr nobr="true">';
...
$pdf->Output('Laporan_List_Slip_Gaji_' . str_replace(' ', '_', $bulan) . '.pdf', 'I');
?>