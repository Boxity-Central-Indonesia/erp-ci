			...
			<div class="breadcrumb-main">
				...
				<div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <div class="dropdown action-btn" hidden>
                    	<a target="_blank" href="<?= base_url('transaksi/bahan_baku/cetak') ?>" id="btn-cetak" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button">
				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-barangpembantu" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2">
