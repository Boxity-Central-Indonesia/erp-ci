<script>
    const $table = $('#table-terimapiutangdetail').DataTable({
        "paging": false,
        "lengthChange": false,
        "searching": false,
        "ordering": true,
        ...
        "ajax": {
            "url": "<?= base_url('transaksi/terima_piutang/detail'); ?>",
            "type": "GET",
            "data": function(d) {
    ...
    $(document).ready(function() {
        ...
        $("#table-terimapiutangdetail").on("click", ".btnhapus", function() {
    ...
    function simpan(self, data_post) {
        post_response("<?= base_url('transaksi/terima_piutang/simpandetail') ?>", data_post, function(response) {
            if (response.status) {
    ...
    function hapus(kode) {
        ...
        get_response("<?= base_url('transaksi/terima_piutang/hapusdetail') ?>", data, function(response) {
    ...
    $("#table-terimapiutangdetail").on("click", ".btnedit", function() {
