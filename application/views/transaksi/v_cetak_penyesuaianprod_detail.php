...
$pdf->SetTitle('Cetak Detail Penyesuaian Produksi');
...
<head>
  ...
  <title>Cetak Detail Penyesuaian Produksi</title>
...
<body>
<div class="container">
    <div class="text-center" style="font-size:14pt; font-weight:bold;"><u>DETAIL PENYESUAIAN PRODUKSI</u></div>
    <br>
    <table width="100%" class="table table-borderless" style="font-size: 11pt; padding: 1.2px">
        <tr>
            <td class="text-left" style="width:25%">Kode Penyesuaian Produksi</td>
            <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . $dtinduk['NoTrans'] . '</td>
            <td class="text-left" style="width:25%">Created By</td>
            <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . $dtinduk['ActualName'] . '</td>
        </tr>
        <tr>
            <td class="text-left" style="width:25%">Gudang Asal</td>
            <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . $dtinduk['NamaGudangAsal'] . '</td>
            <td class="text-left" style="width:25%">Gudang Tujuan</td>
            <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . $dtinduk['NamaGudangTujuan'] . '</td>
        </tr>
        <tr>
            <td class="text-left" style="width:25%">Tgl. Mulai Produksi</td>
            <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . $TglMulai . '</td>
            <td class="text-left" style="width:25%">Tgl. Selesai Produksi</td>
            <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . $TglSelesai . '</td>
        </tr>
    </table>
    <br>
    ...
    <table width="100%"  border="1" style="font-size: 11pt; padding: 1.2px">
        ...
        foreach ($dtproduksi as $row) {
            ...
            $html .= '<td class="text-center">' . $no . '</td>';
            $html .= '<td class="text-left">' . $row['NamaBarang'] . '</td>';
            $html .= '<td class="text-right">' . str_replace(['.', ',', '+'], ['+', '.', ','], number_format($row['BeratKotor'], 2)) . ' kilogram</td>';
            $html .= '<td class="text-right">' . str_replace(['.', ',', '+'], ['+', '.', ','], number_format($row['PemakaianBahanMasak'], 2)) . ' kilogram</td>';
            $html .= '<td class="text-right">' . str_replace(['.', ',', '+'], ['+', '.', ','], number_format($row['Total'], 2)) . '</td>';
            $html .= '</tr>';
    
            $no++;
            $beratprod += $row['BeratKotor'];
