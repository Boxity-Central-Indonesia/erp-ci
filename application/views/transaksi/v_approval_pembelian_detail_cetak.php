...
$pdf->SetTitle('Detail Approval Transaksi Pembelian (PO)');
...
<head>
  ...
  <title>Detail Approval Transaksi Pembelian (PO)</title>
...
<div class="container text-center">
    <span class="text-center" style="font-size:15pt; font-weight:bold;">Approval Transaksi Pembelian (PO)</span>
</div>
<br>
...
<table width="100%" class="table table-borderless" style="font-size: 12pt; padding: 1.5px">
    ...
    <tr>
        <td class="text-left" style="line-height: 20px; width:15%">No Approved</td>
        <td class="text-left" style="line-height: 20px; width:35%">&nbsp;:&nbsp;' . $dtinduk['ApprovedNo'] . '</td>
        <td class="text-left" style="line-height: 20px; width:15%">Approved Oleh</td>
        <td class="text-left" style="line-height: 20px; width:35%">&nbsp;:&nbsp;' . $dtinduk['ApprovedBy'] . '</td>
    </tr>
    <tr>
        <td class="text-left" style="line-height: 20px; width:15%">Tgl Approved</td>
        <td class="text-left" style="line-height: 20px; width:35%">&nbsp;:&nbsp;' . $ApprovedDate . '</td>
        <td class="text-left" style="line-height: 20px; width:15%">Keterangan</td>
        <td class="text-left" style="line-height: 20px; width:35%">&nbsp;:&nbsp;' . $dtinduk['ApprovedDesc'] . '</td>
    </tr>
</table>
<br><br>
...
foreach ($model as $row) {
    ...
    $html .= '<td class="text-right">' . number_format($row['HargaSatuan']) . '</td>';
...
$pdf->Output('Approval_pembelian_po' . $dtinduk['IDTransBeli'] . '.pdf', 'I');
