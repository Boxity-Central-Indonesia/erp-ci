            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <div class="dropdown action-btn">
                        <a target="_blank" href="<?= base_url('transaksi/mutasi_gudang/cetakdetail/' . base64_encode($NoTrans)) ?>" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button">
        ...
        <div class="col-lg-12 mb-30">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div  class="userDatatable global-shadow border-0 bg-white w-100">
                        <div class="table-responsive">
                            ...
                            <table id="table-mutasigdgdetail" class="table mb-0 table-borderless">
                                <thead>
                                    <tr hidden>
                                        <td colspan="2">
                                    ...
                                    <tr class="userDatatable-header">
                                        ...
                                        <th style="display: table-cell;" class="text-center"><span class="userDatatable-title">Stok Gudang Asal </span></th>
                                        <th style="display: table-cell;" class="text-center"><span class="userDatatable-title">Stok Gudang Tujuan </span></th>
                                        <?php
                ...
                <div class="card-footer">
                    <!-- <a href="<?=base_url('transaksi/mutasi_gudang')?>" class="btn btn-sm btn-primary">Simpan</a> -->
                    <a href="<?=base_url('transaksi/mutasi_gudang')?>" class="btn btn-sm btn-secondary">Kembali</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade ui-dialog" id="ModalTambah" role="dialog">
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('transaksi/mutasi_gudang/simpandetail') ?>" method="post" id="form-simpan">
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Stok Gudang Asal</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Stok Gudang Tujuan</label>
                                <div class="position-relative input-group">
                                    <input type="number" class="form-control" id="StokTujuan" name="StokTujuan" required>
                                    <div class="input-group-append" style="cursor: pointer">
                                        <div class="input-group-text">
