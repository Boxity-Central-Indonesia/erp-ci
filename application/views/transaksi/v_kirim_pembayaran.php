            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <div class="dropdown action-btn" hidden>
                        <!-- <a target="_blank" href="<?= base_url('transaksi/transaksi_pembelian/cetakkirimpembayaran/' . base64_encode($dtiinduk['KodePerson'])) ?>" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button">
        ...
        <div class="col-lg-12 mb-30">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('transaksi/transaksi_pembelian/kirimpembayaranproses') ?>" method="post" id="form-kirimbayar">
                    <div  class="userDatatable global-shadow border-0 bg-white w-100">
                        <div class="table-responsive">
                            <table class="table mb-0 table-borderless" style="font-size:14px;">
                                <tr>
                                    <td style="width: 15%;">Kode Supplier </td>
                            ...
                            <br>
                            <table id="table-kirimbayar" class="table mb-0 table-borderless">
                                <thead>
                                    <tr hidden>
                                        <td colspan="2">
                    ...
                    <div class="row clearfix">
                        ...
                        <a href="<?= base_url('transaksi/transaksi_pembelian/detail/' . base64_encode($IDTransBeli)) ?>" type="button" class="btn btn-sm btn-secondary">Kembali</a>
                        <?php if ($countdata > 0 && $status_jurnal == 'on') { ?>
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Edit Bayar Hutang</h4>
            </div>
            <form action="<?= base_url('transaksi/transaksi_pembelian/editpertransaksi') ?>" method="post" id="form-simpan">
