...
<table width="100%" class="table table-borderless" style="font-size: 10pt; padding: 1px">
    <tr>
        ...
        <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . $dtinduk['IDTransJual'] . '</td>
        <td class="text-left" style="width:25%">Kode Customer</td>
        <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . $dtinduk['KodePerson'] . '</td>
    </tr>
    <tr>
        <td class="text-left" style="width:25%">Tanggal Slip Order</td>
        <td class="text-left" style="width:25%">&nbsp;:&nbsp;' . shortdate_indo(date('Y-m-d', strtotime($dtinduk['TglSlipOrder']))) . ' ' . date('H:i', strtotime($dtinduk['TglSlipOrder'])) . '</td>
...
foreach ($model as $row) {
    ...
    $html .= '<td class="text-center">' . $row['Kategory'] . '</td>';
