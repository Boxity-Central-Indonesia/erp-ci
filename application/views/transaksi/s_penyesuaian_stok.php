<script>
    const $table = $('#table-penyesuaianstok').DataTable({
        "paging": true,
        "lengthChange": false,
        "searching": false,
        "ordering": true,
        ...
        "ajax": {
            "url": "<?= base_url('transaksi/penyesuaian_stok'); ?>",
            "type": "GET",
            "data": function(d) {
    ...
    $(document).ready(function() {
        ...
        $("#table-penyesuaianstok").on("click", ".btnhapus", function() {
    ...
    function hapus(kode) {
        ...
        get_response("<?= base_url('transaksi/penyesuaian_stok/hapus') ?>", data, function(response) {
    ...
    function simpan(self, data_post) {
        post_response("<?= base_url('transaksi/penyesuaian_stok/simpan') ?>", data_post, function(response) {
            if (response.status) {
                ...
                showSwal("success", "Informasi", "Berhasil input data").then(function() {
                    ...
                    if (response.action === 'tambah') {
                        window.location.href = "<?= base_url('transaksi/penyesuaian_stok/detail/') ?>" + btoa(unescape(encodeURIComponent(response.id)));
                    }
                });
            } else {
                $('#ModalTambah').modal('hide');
    ...
    $("#table-penyesuaianstok").on("click", ".btnedit", function() {
