            ...
            <div class="breadcrumb-main">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <div class="dropdown action-btn" hidden>
                        <a target="_blank" href="<?= base_url('transaksi/transaksi_pinjaman/cetak') ?>" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button" id="btn-cetak">
                            ...
                            <table id="table-pinjaman" class="table mb-0 table-borderless">
                                <thead>
                                    ...
                                    <tr class="userDatatable-header">
                                        ...
                                        <th style="display: table-cell;"><span class="userDatatable-title">Tanggal Pinjam </span></th>
                                        <th style="display: table-cell;"><span class="userDatatable-title">Minggu Ke </span></th>
                                        <th style="display: table-cell;" class="text-center"><span class="userDatatable-title">Nominal Pinjam </span></th>
                                        <th style="display: table-cell;" class="text-center"><span class="userDatatable-title">Nominal Dibayar </span></th>
                                        <th style="display: table-cell;" class="text-center"><span class="userDatatable-title">Keterangan </span></th>
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Data Transaksi Pinjaman Karyawan</h4>
            </div>
            <form action="<?= base_url('transaksi/transaksi_pinjaman/simpan') ?>" method="post" id="form-simpan">
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="exampleInputFile">Nama Pegawai</label>
                                <input type="hidden" class="form-control" id="KodeTrPinjam" name="KodeTrPinjam">
                                <input type="hidden" class="form-control" id="isedit" name="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" id="TanggalPinjam" name="TanggalPinjam" required>
                            </div>
                            <div class="form-group">
                                <label class="form-control-label">Nominal Pinjaman</label>
                                <input type="text" class="form-control" id="NominalPinjam" name="NominalPinjam" required>
                            </div>
                            <div class="form-group">
