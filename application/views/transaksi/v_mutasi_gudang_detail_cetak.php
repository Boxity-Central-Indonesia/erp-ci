...
$pdf->SetTitle('Detail Transaksi Mutasi Gudang');
...
<head>
  ...
  <title>Detail Transaksi Mutasi Gudang</title>
...
<div class="container text-center">
    <span class="text-center" style="font-size:15pt; font-weight:bold;">Transaksi Mutasi Gudang</span>
</div>
<br>
...
<table width="100%" class="table table-borderless" style="font-size: 12pt; padding: 1px">
    <tr>
        ...
        <td class="text-left" style="line-height: 20px; width:15%">Gudang Asal</td>
    ...
    <tr>
        ...
        <td class="text-left" style="line-height: 20px; width:15%">Gudang Tujuan</td>
        <td class="text-left" style="line-height: 20px; width:35%">&nbsp;:&nbsp;' . $dtinduk['NamaGudangTujuan'] . '</td>
    </tr>
    <tr>
...
<table width="100%"  border="1" style="font-size: 12pt; padding: 1px">
    <tr>
        ...
        <td class="text-center" style="line-height: 20px; width:25%"><b>Stok Gudang Asal</b></td>
        <td class="text-center" style="line-height: 20px; width:25%"><b>Stok Gudang Tujuan</b></td>
    </tr>';
...
$pdf->Output('Transaksi_mutasi_gudang_' . $NoTrans . '.pdf', 'I');
?>