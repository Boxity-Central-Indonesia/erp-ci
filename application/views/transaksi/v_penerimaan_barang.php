				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-penerimaan" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2" hidden>
					                ...
					                <tr class="userDatatable-header">
					                    ...
					                    <th style="display: table-cell;"><span class="userDatatable-title">No Trans Terima Barang </span></th>
					                    <th style="display: table-cell;"><span class="userDatatable-title">No Ref Terima Barang </span></th>
					                    <th style="display: table-cell;"><span class="userDatatable-title">Tgl Penerimaan </span></th>
					                    <th style="display: table-cell;"><span class="userDatatable-title">No Trans Pembelian </span></th>
					                    <th style="display: table-cell;"><span class="userDatatable-title">No Ref Pembelian </span></th>
					                    <th style="display: table-cell;"><span class="userDatatable-title">Tgl Pembelian </span></th>
					                    <th style="display: table-cell;"><span class="userDatatable-title">Nama Supplier </span></th>
					                    <th style="display: table-cell;"><span class="userDatatable-title">Status Terima </span></th>
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Data Penerimaan Barang</h4>
            </div>
            <form action="<?= base_url('transaksi/penerimaan_barang/simpan') ?>" method="post" id="form-simpan">
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-6">
                            <div class="form-group" hidden>
                                <label for="exampleInputFile">No Referensi Terima Barang</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Tanggal Penerimaan</label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputFile">No Transaksi Pembelian</label>
                                <select class="form-control form-select" name="NoRefTrSistem" id="NoRefTrSistem" required disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="KodePO" name="" readonly>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">No Referensi Pembelian</label>
                                <input type="text" class="form-control" id="NoRef_Manual" name="" readonly>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Tanggal Pembelian</label>
                                <input type="datetime-local" class="form-control" id="TanggalPembelian" name="" readonly>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Supplier</label>
                                <input type="text" class="form-control" id="Supplier" name="" readonly>
                                <input type="hidden" class="form-control" id="KodePerson" name="KodePerson" readonly>
                            </div>
                        </div>
                    </div>
                </div>
