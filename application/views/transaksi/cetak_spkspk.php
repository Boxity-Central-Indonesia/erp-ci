...
<div class="container">
    ...
    <table width="100%" class="table table-borderless" style="font-size: 10pt; padding: 1px">
        <tr>
            ...
            <td class="text-left" style="width:75%">&nbsp;:&nbsp;' . $dtinduk['NoRefTrManual'] . '</td>
        </tr>
        <tr>
            <td class="text-left" style="width:25%">Tgl. Orderan</td>
            <td class="text-left" style="width:75%">&nbsp;:&nbsp;' . $SPKTanggal . '</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="text-left" style="width:75%">&nbsp;:&nbsp;' . $NamaUsaha . '</td>
        </tr>
    </table>
...
foreach ($model as $row) {
    ...
    $ukuran = isset($row['ProdUkuran']) ? $row['ProdUkuran'] : '';
    $jmldaun = isset($row['ProdJmlDaun']) ? $row['ProdJmlDaun'] . ' daun' : '';

    $html .= '<tr nobr="true">';
    $html .= '<td class="text-center">' . $no . '</td>';
    $html .= '<td class="text-left">' . $barang . '</td>';
    $html .= '<td class="text-left">' . $ukuran . ' ' . $jmldaun . '</td>';
