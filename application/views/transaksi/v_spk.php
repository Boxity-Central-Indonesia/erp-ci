				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-spk" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2" hidden>
...
<div class="modal fade ui-dialog" id="ModalTambah" role="dialog">
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('transaksi/spk/simpan') ?>" method="post" id="form-simpan">
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputFile">No Orderan</label>
                            ...
                            <div class="form-group">
								...
								<select class="form-control form-select select2" name="Gudang" id="Gudang" disabled required>
                        ...
                        <div class="col-sm-6">
                        	<div class="form-group">
                            	<label for="exampleInputFile">No SPK</label>
                            	<select class="form-control form-select select2" id="SPKNomor" name="" disabled>
                            		<option value="" selected>Pilih Nomor SPK</option>
                            		<?php if($dtspk){
                                        foreach ($dtspk as $key) {
                                            echo '<option value="'.$key['SPKNomor'].'">'.$key['SPKNomor'].'</option>';
                                        }
                                    } ?>
                            	</select>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Tanggal SPK</label>
                                <input type="datetime-local" class="form-control" id="SPKTanggal" name="" readonly>
                                <input type="hidden" class="form-control" id="NoRefTrSistem" name="NoRefTrSistem">
                            </div>
                            <div class="form-group">
                            	<label for="exampleInputFile">No Slip Order | Customer</label>
