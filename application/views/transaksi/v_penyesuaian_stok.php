				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-penyesuaianstok" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2" hidden>
					                ...
					                <tr class="userDatatable-header">
					                    ...
					                    <th style="display: table-cell;"><span class="userDatatable-title">Gudang</span></th>
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Data Penyesuaian Stok</h4>
            </div>
            <form action="<?= base_url('transaksi/penyesuaian_stok/simpan') ?>" method="post" id="form-simpan">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-select" name="Gudang" id="Gudang" disabled required>
                                    <option></option>
                                </select>
                            </div>
                            <div class="form-group">
