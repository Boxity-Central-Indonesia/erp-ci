...
$pdf->SetTitle('Detail Transaksi Terima Piutang');
...
<head>
  ...
  <title>Detail Transaksi Terima Piutang</title>
...
<div class="container text-center">
    <span class="text-center" style="font-size:15pt; font-weight:bold;">Transaksi Terima Piutang</span>
</div>
<br>

<table width="100%" class="table table-borderless" style="font-size: 10pt; padding: 1px">
    <tr>
        <td class="text-left" style="line-height: 20px; width:25%">Kode Transaksi Penjualan</td>
    ...
    <tr>
        <td class="text-left" style="line-height: 20px; width:25%">No Referensi Penjualan</td>
...
<table width="100%"  border="1" style="font-size: 10pt; padding: 1px">
    <tr>
        ...
        <td class="text-center" style="line-height: 20px; width:20%"><b>No Ref Terima Piutang</b></td>
        <td class="text-center" style="line-height: 20px; width:20%"><b>Tanggal Terima Piutang</b></td>
...
$pdf->Output('Transaksi_terima_piutang_' . $dtinduk['IDTransJual'] . '.pdf', 'I');
