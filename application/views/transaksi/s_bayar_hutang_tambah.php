<script>
    const $table = $('#table-bayarhutangtambah').DataTable({
        "paging": false,
        "lengthChange": false,
        "searching": false,
        "ordering": true,
        ...
        "ajax": {
            "url": "<?= base_url('transaksi/bayar_hutang/tambah'); ?>",
            "type": "GET",
            "data": function(d) {
    ...
    function simpan(self, data_post) {
        post_response("<?= base_url('transaksi/bayar_hutang/simpantambah') ?>", data_post, function(response) {
            if (response.status) {
    ...
    function hapusbayar(kode) {
        ...
        get_response("<?= base_url('transaksi/bayar_hutang/hapustambah') ?>", data, function(response) {
    ...
    function simpanbayar(kode) {
        ...
        get_response("<?= base_url('transaksi/bayar_hutang/verifikasitambah') ?>", data, function(response) {
            if (response.status === false) {
                showSwal('error', 'Peringatan', 'Data gagal dihapus.');
                return false;
            } else {
    ...
    $("#table-bayarhutangtambah").on("click", ".btnedit", function() {
