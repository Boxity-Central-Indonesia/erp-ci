...
<div class="modal fade ui-dialog" id="ModalTambah" role="dialog">
	<div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url('transaksi/transaksi_pembelian/simpan') ?>" method="post" id="form-simpan">
					...
					<div class="row clearfix">
						<div class="col-sm-12">
							...
							<div class="form-group">
								...
								<select class="form-control form-select" name="IDTransBeli" id="IDTransBeli" disabled>
