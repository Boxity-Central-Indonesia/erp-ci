				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-mutasigdg" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2" hidden>
					                ...
					                <tr class="userDatatable-header">
					                    ...
					                    <th style="display: table-cell;"><span class="userDatatable-title">Gudang Asal </span></th>
					                    <th style="display: table-cell;"><span class="userDatatable-title">Gudang Tujuan </span></th>
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Data Mutasi Stok Gudang</h4>
            </div>
            <form action="<?= base_url('transaksi/mutasi_gudang/simpan') ?>" method="post" id="form-simpan">
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Gudang Asal</label>
                                <select class="form-control form-select" name="GudangAsal" id="GudangAsal" disabled required>
                                    <option></option>
                                </select>
                            </div>
                            <div class="form-group">
                            	<label for="exampleInputFile">Gudang Tujuan</label>
                            	<select class="form-control form-select" id="GudangTujuan" name="GudangTujuan" disabled required>
                            		<option></option>
                            	</select>
                            </div>
                            <div class="form-group">
