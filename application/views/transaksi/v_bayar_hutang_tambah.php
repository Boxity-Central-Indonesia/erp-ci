                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <?php if ($canPrint == 1) { ?>
                        <div class="dropdown action-btn" hidden>
                            <!-- <a target="_blank" href="<?= base_url('transaksi/bayar_hutang/cetakdetail/' . base64_encode($dtiinduk['KodePerson'])) ?>" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button">
                    ...
                    <div class="userDatatable global-shadow border-0 bg-white w-100">
                        <div class="table-responsive">
                            <table class="table mb-0 table-borderless" style="font-size:14px;">
                                <tr>
                                    <td>No Ref Bayar Hutang </td>
                                    <td>: <?= $dtinduk['NoRef_Manual'] ?></td>
                                    <td>Kode Supplier </td>
                                    <td>: <?= $dtinduk['KodePerson'] ?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Bayar Hutang </td>
                            ...
                            <br>
                            <table id="table-bayarhutangtambah" class="table mb-0 table-borderless">
                                <thead>
                                    <tr hidden>
                                        <td colspan="2">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="TanggalPembelian" name="TanggalPembelian" readonly>
                            </div>
                            <div class="form-group">
