		...
		<div class="col-lg-12">
			...
			<div class="breadcrumb-main">
				...
				<div class="breadcrumb-action justify-content-center flex-wrap">
					...
					<?php
                        $FiturID = 20; //FiturID di tabel serverfitur
                        $canPrint = 0;
                        $print = [];
                    ...
                    <div class="dropdown action-btn" hidden>
                    	<a target="_blank" href="<?= base_url('transaksi/barang_jadi/cetak') ?>" id="btn-cetak" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button">
				...
				<div class="card-body">
					...
					<div  class="userDatatable global-shadow border-0 bg-white w-100">
						<div class="table-responsive">
							<table id="table-barangjadi" class="table mb-0 table-borderless">
								<thead>
									<tr>
					                    <td colspan="2">
