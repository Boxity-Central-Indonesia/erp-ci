                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    ...
                    <?php if ($canPrint == 1) { ?>
                        <div class="dropdown action-btn">
                            <a target="_blank" href="<?= base_url('transaksi/retur/cetakdetail/' . base64_encode($IDTransRetur)) ?>" class="btn btn-sm btn-default btn-white dropdown-toggle" type="button">
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Data Retur Penjualan Detail</h4>
            </div>
            <form action="<?= base_url('transaksi/retur/simpandetail') ?>" method="post" id="form-simpan">
...
<div class="modal fade ui-dialog" id="ModalRetur" role="dialog">
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('transaksi/retur/simpanretur') ?>" method="post" id="form-simpan-retur">
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="IDTransRetur" name="IDTransRetur" value="<?= $IDTransRetur ?>">
                                <input type="text" class="form-control" id="IDTransJual" name="IDTrans" value="<?= $dtinduk['IDTransJual'] ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" id="TglPenjualan" name="" value="<?= $dtinduk['TanggalPenjualan'] ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
