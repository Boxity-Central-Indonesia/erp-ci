                ...
                <div class="card-body">
                    ...
                    <div  class="userDatatable global-shadow border-0 bg-white w-100">
                        <div class="table-responsive">
                            <table id="table-jabatan" class="table mb-0 table-borderless">
                                <thead>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr class="userDatatable-header">
                                        ...
                                        <th style="display: table-cell;"><span class="userDatatable-title">Nama Jabatan </span></th>
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Data Jabatan</h4>
            </div>
            <form action="<?= base_url('master/jabatan/simpan') ?>" method="post" id="form-simpan">
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="exampleInputFile">Nama Jabatan</label>
                                <input type="hidden" class="form-control" id="KodeJabatan" name="KodeJabatan" value="">
                                <input type="text" class="form-control" id="NamaJabatan" name="NamaJabatan" value="" required>
                            </div>
                            <div class="form-group">
