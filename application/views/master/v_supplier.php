                ...
                <div class="card-body">
                    ...
                    <div class="userDatatable global-shadow border-0 bg-white w-100">
                        <div class="table-responsive">
                            <table id="table-supplier" class="table mb-0 table-borderless">
                                <thead>
                                    <tr>
                                        <td colspan="2">
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Data Supplier</h4>
            </div>
            <form action="<?= base_url('master/person/simpansupplier') ?>" method="post" id="form-simpan">
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputFile">Nama Supplier</label>
                                <input type="hidden" name="KodePerson" id="KodePerson" value="">
                                <input type="text" class="form-control" id="NamaPersonCP" name="NamaPersonCP" value="" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">No HP</label>
                                <input type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==15) return false;" class="form-control" id="NoHP" name="NoHP" value="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Alamat</label>
                                <input type="text" class="form-control" id="AlamatPerson" name="AlamatPerson" value="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputFile">Nama Usaha</label>
                                <input type="text" class="form-control" id="NamaUsaha" name="NamaUsaha" value="" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Kode Manual</label>
                                <input type="text" class="form-control" id="KodeManual" name="KodeManual" value="">
                            </div>
                            <div class="form-group">
