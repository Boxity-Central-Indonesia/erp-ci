                ...
                <div class="card-body">
                    ...
                    <div class="userDatatable global-shadow border-0 bg-white w-100">
                        <div class="table-responsive">
                            <table id="table-customer" class="table mb-0 table-borderless">
                                <thead>
                                    <tr>
                                        <td colspan="2">
    ...
    <div class="modal-dialog modal-lg ui-dialog-content modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Tambah Data Customer</h4>
            </div>
            <form action="<?= base_url('master/person/simpancustomer') ?>" method="post" id="form-simpan">
