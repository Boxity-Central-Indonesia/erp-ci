<script>
    const $table = $('#table-supplier').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url('master/person/supplier'); ?>",
            "type": "GET",
            "data": function(d) {
    ...
    $(document).ready(function() {
        ...
        $("#table-supplier").on("click", ".btnhapus", function() {
    ...
    function simpan(self, data_post) {
        post_response("<?= base_url('master/person/simpansupplier') ?>", data_post, function(response) {
            if (response.status) {
    ...
    $("#table-supplier").on("click", '.btnaktif', function() {
        ...
        function aktif(value, kode) {
            ...
            get_response("<?= base_url('master/person/aktif') ?>", data, function(response) {
                if (response.status === false) {
                    showSwal('error', 'Peringatan', 'Data supplier gagal diubah.');
                    return false;
                } else {
                    $table.ajax.reload();
                    showSwal('success', 'Berhasil', 'Data supplier berhasil diubah.');
    ...
    $("#table-supplier").on("click", ".btnedit", function() {
