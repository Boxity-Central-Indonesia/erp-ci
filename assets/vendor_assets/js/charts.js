...
function chartjsLineChartForcast(
  selector,
  label = "",
  startGradient = "#F95B1212",
  endGradient = "#F95B1202",
  bColor = "#20C997",
      ...
      var chart = new Chart(elm, {
        ...
        data: {
          ...
          datasets: [{
            ...
            // backgroundColor: bgColor,
            borderColor: bColor,
            pointHoverBackgroundColor: "#F95B12",
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
            data: dataG,
            backgroundColor: "#F95B1280",
            hoverBackgroundColor: "#F95B12",
            label: "Gained",
          },
          // {
          //   data: dataL,
...
chartJsBarChartThree("mychart8", "#F95B1220", "#F95B12", "Order");
chartJsBarChartThree("mychart9", "#20324720", "#203247", "Revenue");
chartJsBarChartThree("mychart10", "#20C99720", "#20C997", "Avg. Order");
chartJsBarChartThree("mychart11", "#2C99FF20", "#2C99FF", "Visitors");


chartJsBarChartFour("mychart12", "#20324720", "#203247", "New Contact");
chartJsBarChartFour("mychart13", "#F95B1220", "#F95B12", "New Deals");
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          data: data,
          backgroundColor: ["#20C997", "#F95B12", "#FA8B0C"],
          total: "9,283",
        }, ],
      },
      options: {
